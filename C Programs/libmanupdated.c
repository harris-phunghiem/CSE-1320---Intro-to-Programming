...
/*
                while (1)
                {
                    ...
                    printf("\nWhat year is it due?\n");
                    scanf("%d%c",&due[nBook_Selection].nYear,&lolSpace);

                    if (due[nBook_Selection].nYear < 0 || due[nBook_Selection].nYear > 9999)
                    {
                ...
                {
                    printf("Due month (MM) ");
                    scanf("%d%c",&due[nBook_Selection].nMonth,&lolSpace);
                    if (due[nBook_Selection].nMonth < 1 || due[nBook_Selection].nMonth >12)
                    {
                ...
                {
                    printf("\nDue day (DD) ");
                    scanf("%d%c",&due[nBook_Selection].nDay,&lolSpace);

                    if (dayLegalityCheck(due[nBook_Selection].nMonth,due[nBook_Selection].nDay,due[nBook_Selection].nYear) == 0)
                    {
...
int dayLegalityCheck(int month1, int day1, int year1)
{
    ...
    //printf("The current month/day/year is %d/%d/%d\n",month1,day1,year1);
